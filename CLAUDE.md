...
- Past single-event proposals have ranged **$800–$875** for ~20–40 attendees.
...
Standardized copies live in `past-proposals/` (filename: `YYMMDD-event-slug.md`, with a matching `.pdf` where a submitted copy exists). The original working files remain in `archive/` (untracked, local-only).

| File | Event | Total Budget |
| :---- | :---- | :---- |
| `past-proposals/251107-interview-prep-night.md` | Interview Prep Night with Food, Nov 7 2025 | *not stated in source* |
| `past-proposals/251219-ml-trivia-night.md` | ML Trivia Night with Dinner, Dec 19 2025 | $1,000 (stated) / $960 (itemized) |
| `past-proposals/260122-wellness-cafe.md` | Drop-in Wellness Café, Jan 22 2026 | $1,250 |
| `past-proposals/260206-bouldering-social-mixer.md` | Bouldering & Social Mixer, Feb 6 2026 | $1,050 |
| `past-proposals/260208-super-bowl-watch-party.md` | Super Bowl Watch Party, Feb 8 2026 | $875 |
| `past-proposals/260212-lunar-new-year-celebration.md` | Lunar New Year Celebration & Alumni Mixer, Feb 12 2026 | $2,315 |
| `past-proposals/260227-poker-social.md` | MScAC Poker Social, Feb 27 2026 | $850 |
| `past-proposals/260703-board-game-nights.md` | Board Game Nights (4-week series, July 17 dropped), Jul 3–31 2026 | $650 |
